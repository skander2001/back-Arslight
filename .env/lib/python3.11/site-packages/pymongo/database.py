...
class Database(common.BaseObject):
    ...
    def __init__(
        ...
        if not isinstance(name, string_type):
            raise TypeError(
                "name must be an instance " "of %s" % (string_type.__name__,)
            )
    ...
    def add_son_manipulator(self, manipulator):
        ...
        **DEPRECATED** - `add_son_manipulator` is deprecated.
        ...
        """
        warnings.warn(
            "add_son_manipulator is deprecated", DeprecationWarning, stacklevel=2
        )
        base = SONManipulator()
    ...
    def incoming_manipulators(self):
        ...
        """
        warnings.warn(
            "Database.incoming_manipulators() is deprecated",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _list_collections(
        self, sock_info, secondary_okay, session, read_preference, **kwargs
    ):
    ...
    def validate_collection(
        ...
        cmd = SON(
            [("validate", _unicode(name)), ("scandata", scandata), ("full", full)]
        )
    ...
    def profiling_level(self, session=None):
        ...
        """
        warnings.warn(
            "profiling_level() is deprecated. See the documentation "
    ...
    def set_profiling_level(
        self, level, slow_ms=None, session=None, sample_rate=None, filter=None
    ):
        ...
        """
        warnings.warn(
            "set_profiling_level() is deprecated. See the "
    ...
    def profiling_info(self, session=None):
        ...
        """
        warnings.warn(
            "profiling_info() is deprecated. See the "
            "documentation for more information",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def error(self):
        ...
        """
        warnings.warn(
            "Database.error() is deprecated", DeprecationWarning, stacklevel=2
        )
    ...
    def previous_error(self):
        ...
        """
        warnings.warn(
            "previous_error() is deprecated", DeprecationWarning, stacklevel=2
        )
    ...
    def reset_error_history(self):
        ...
        """
        warnings.warn(
            "reset_error_history() is deprecated", DeprecationWarning, stacklevel=2
        )
    ...
    def add_user(self, name, password=None, read_only=None, session=None, **kwargs):
        ...
        if password is not None:
            if not isinstance(password, string_type):
                raise TypeError(
                    "password must be an " "instance of %s" % (string_type.__name__,)
                )
            if len(password) == 0:
    ...
    def authenticate(
        self, name=None, password=None, source=None, mechanism="DEFAULT", **kwargs
    ):
        ...
        if source is not None and not isinstance(source, string_type):
            raise TypeError(
                "source must be an " "instance of %s" % (string_type.__name__,)
            )
    ...
    def logout(self):
        ...
        """
        warnings.warn(
            "Database.logout() is deprecated", DeprecationWarning, stacklevel=2
        )
