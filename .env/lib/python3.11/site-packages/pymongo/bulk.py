...
class BulkWriteOperation(object):
    ...
    def update_one(self, update):
        ...
        """
        self.__bulk.add_update(
            self.__selector, update, multi=False, collation=self.__collation
        )
    ...
    def update(self, update):
        ...
        """
        self.__bulk.add_update(
            self.__selector, update, multi=True, collation=self.__collation
        )
    ...
    def replace_one(self, replacement):
        ...
        """
        self.__bulk.add_replace(
            self.__selector, replacement, collation=self.__collation
        )
