...
class SocketInfo(object):
    ...
    def _hello(
        self, cluster_time, topology_version, heartbeat_frequency, all_credentials
    ):
        cmd = self.hello_cmd()
    ...
    def legacy_write(self, request_id, msg, max_doc_size, with_last_error):
        ...
        if with_last_error:
            ...
            return helpers._check_gle_response(
                reply.command_response(), self.max_wire_version
            )
...
def _create_connection(address, options):
    ...
    for res in socket.getaddrinfo(host, port, family, socket.SOCK_STREAM):
        ...
        try:
            ...
            sock.setsockopt(
                socket.SOL_SOCKET, socket.SO_KEEPALIVE, options.socket_keepalive
            )
