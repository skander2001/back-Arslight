...
class GridFSBucket(object):
    ...
    def open_upload_stream(
        self, filename, chunk_size_bytes=None, metadata=None, session=None
    ):
        ...
        return GridIn(
            self._collection, session=session, disable_md5=self._disable_md5, **opts
        )
    ...
    def download_to_stream_by_name(
        self, filename, destination, revision=-1, session=None
    ):
