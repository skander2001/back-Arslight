...
def validate_options(options):
    ...
    if kwcase not in [None, "upper", "lower", "capitalize"]:
        raise SQLParseError("Invalid value for keyword_case: " "{0!r}".format(kwcase))
    ...
    if truncate_strings is not None:
        try:
            ...
            raise SQLParseError(
                "Invalid value for truncate_strings: " "{0!r}".format(truncate_strings)
            )
    ...
    if reindent not in [True, False]:
        raise SQLParseError("Invalid value for reindent: " "{0!r}".format(reindent))
    elif reindent:
