...
class Converter:
    ...
    def __init__(
        self,
        query: U["query_module.SelectQuery", "query_module.BaseQuery"],
...
class ColumnSelectConverter(Converter):
    def __init__(self, query, statement):
        ...
        self.sql_tokens: List[U[SQLIdentifier, SQLFunc]] = []
...
class WhereConverter(Converter):
    ...
    def parse(self):
        ...
        self.op = WhereOp(
            statement=SQLStatement(tok), query=self.query, params=self.query.params
        )
...
class _Tokens2Id:
    sql_tokens: List[U[SQLIdentifier, SQLFunc]]
    query: U["query_module.SelectQuery", "query_module.BaseQuery"]
...
class HavingConverter(Converter):
    ...
    def parse(self):
        ...
        self.op = WhereOp(statement=tok, query=self.query, params=self.query.params)
